---
name: deep-research
description: Use for multi-source research, trend reports, launch analysis, technical scans, and questions where freshness or contradictions matter.
---
...
- Use `wiki_enqueue_github`, `wiki_enqueue_arxiv`, and `wiki_enqueue_rss` when those sources should become durable source cards.
