...
- After `research_report_compile`, read the returned report body yourself and
  include the user-facing report content in the final Codex message. At minimum,
  share the title, publication/closure status, executive judgment, key findings,
